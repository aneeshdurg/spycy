...
class CypherParser(Parser):
    ...
    def tck_List(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if (((_la) & ~0x3F) == 0 and ((1 << _la) & 17318208) != 0) or (
                (((_la - 82)) & ~0x3F) == 0 and ((1 << (_la - 82)) & 58783745) != 0
            ):
                self.state = 1588
    ...
    class Tck_PathContext(ParserRuleContext):
        __slots__ = "parser"
        ...
        def getRuleIndex(self):
            return CypherParser.RULE_tck_Path

        def enterRule(self, listener: ParseTreeListener):
            if hasattr(listener, "enterTck_Path"):
                listener.enterTck_Path(self)

        def exitRule(self, listener: ParseTreeListener):
            if hasattr(listener, "exitTck_Path"):
    ...
    class Tck_ExpectedValueContext(ParserRuleContext):
        ...
        def tck_Path(self):
            return self.getTypedRuleContext(CypherParser.Tck_PathContext, 0)
